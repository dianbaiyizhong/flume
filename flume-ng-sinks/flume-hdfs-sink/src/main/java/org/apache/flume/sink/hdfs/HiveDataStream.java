...
public class HiveDataStream extends AbstractHDFSWriter {
    ...
    public void configure(Context context) {
        ...
        logger.info("_______________________________configure");
...
//        }
//        writeBatch(batch, columnVectors, writer, rowList);
    }

    private void writeBatch(VectorizedRowBatch batch, List<BytesColumnVector> columnVectors, Writer writer, List<List<String>> rowList) throws IOException {
